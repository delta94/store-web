...
export default {
  translation: {
    ...
    error_message: {
      ...
      ERR_CONNECTION_TIMED_OUT: 'Соединение длилось слишком долго. Подключение к интернету может быть слишком медленным, или сервер может быть слишком занят',
      ERR_TIMED_OUT: 'Соединение длилось слишком долго. Подключение к интернету может быть слишком медленным, или сервер может быть слишком занят',
